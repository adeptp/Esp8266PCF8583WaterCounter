...
class PCF8583 {
    ...
    public:
        ...
        //Memory work
        void setMemoryLong(uint8_t offset,uint32_t count);
        uint32_t getMemoryLong(uint8_t offset);

        void setMemoryInt(uint8_t offset,uint16_t count);
        uint16_t getMemoryInt(uint8_t offset);

        void setMemoryByte(uint8_t offset,uint8_t count);
